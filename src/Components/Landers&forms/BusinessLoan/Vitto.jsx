...
const VittoLoanForm = () => {
  ...
  const handleInputChange = (e) => {
    ...
    if (name === "dateOfBirth") {
      ...
      if (age < 18) {
        alert("You are not eligible because you are not 18 years old yet.");
        return;
      }
    }
  ...
  const handleOtpRequest = async (e) => {
    ...
    try {
      await axios.post(
        "https://credmantra.com/api/v1/partner-api/vitto/register",
        {
  ...
  const handleOtpVerification = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://credmantra.com/api/v1/partner-api/vitto/login",
        {
          phoneNumber: "+91-" + formData.phoneNumber,
          otp: formData.otp,
        }
  ...
  const handlePanUpload = async () => {
    ...
    try {
      const response = await axios.post(
        "https://credmantra.com/api/v1/partner-api/vitto/pan",
        formDataObj,
        {
          headers: {
  ...
  const handlePersonalDetailsSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://credmantra.com/api/v1/partner-api/vitto/update",
        {
          ...formData,
          userToken: token,
        }
  ...
  const handleLoanDetailsSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://credmantra.com/api/v1/partner-api/vitto/apply",
        {
          loanCategory: "HSF",
          loanSubCategory: "HPL",
          token,
      ...
      case 5:
        return (
          <div className="max-w-md mx-auto text-center py-12">
            ...
            <img src={checkImage} alt="Success" className="w-3/4 mx-auto" />
          </div>
        );
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          ...
          <img src={vittoImage} alt="Vitto Logo" className="h-12 w-auto" />
        </div>
        {renderStage()}
      </div>
    </div>

        ...
        <>
            ...
            <div className="flex flex-col md:flex-row text-center w-full  h-auto">
                <div className="flex flex-col items-center bg-sky-300 w-full md:w-1/2 p-4">
                    <div className="mt-10 space-y-4 sm:space-y-2"  data-aos="fade-right" 
                            data-aos-delay="200"  >
                        <div 
                             className="bg-white h-[45%] mt-[17%] sm:mr-[20%] w-max sm:w-full rounded-lg shadow-lg flex flex-col items-center mr-[30%] p-2 hover:cursor-pointer transition-transform hover:scale-105"
                        ...
                        >
                            ...
                            <p>Our team helps customers <br /> to make informed loan decisions.</p>
                        </div>
                        <div 
                        
                        className="bg-white h-[45%] mt-[17%] sm:ml-[20%] w-max sm:w-full rounded-lg shadow-lg flex flex-col items-center mr-[30%] p-2 hover:cursor-pointer transition-transform hover:scale-105"
                        data-aos={window.innerWidth >= 768 ? "fade-right" : "fade-up"} 
                        data-aos-delay="200"
                        >
                            <div className="rounded-full bg-white ml-0  sm:ml-[20%] h-[60px] flex mt-3 mx-auto w-[60px] justify-center shadow-2xl">
                                <img src={clock} alt="Fast Disbursal" className="w-full h-full" />
                            </div>
                            <h1 className="text-xl font-semibold">Fast Disbursal</h1>
                ...
                <div className="flex flex-col items-center bg-red-300 w-full md:w-1/2 p-4">
                    <div className="mt-10 space-y-4 sm:space-y-2"   data-aos="fade-left" 
                            data-aos-delay="200"  >
                        <div 
                        ...
                        <div 
                          className="bg-white h-[45%] mt-[17%] sm:mr-[20%] w-max sm:w-full rounded-lg shadow-lg flex flex-col items-center mr-[30%] p-2 hover:cursor-pointer transition-transform hover:scale-105"
                          data-aos={window.innerWidth >= 768 ? "fade-right" : "fade-up"} // Change effect based on screen size
                          data-aos-delay="200"
                        >
                            <div className="rounded-full bg-white h-[60px] flex mt-3 mx-auto w-[60px] justify-center shadow-2xl">
                                <img src={clock} alt="Fast Disbursal" className="w-full h-full" />

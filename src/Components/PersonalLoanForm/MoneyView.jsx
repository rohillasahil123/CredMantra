...
const MoneyViewForm = () => {
  ...
  const empOptions = ['salaried'];
  const incomeOptions = ['online'];
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <select
                  name="residenceType"
                  value={formData.addressList[0].residenceType}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  name="email"
                  placeholder='email'
                  value={formData.emailList[0].email}
                  onChange={(e) => handleInputChange(e, 'emailList')}
                  required
                  className="mt-1 block w-[90%] h-8 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                />
              </div>
            ...
            <div className="mt-6">
              <div className="flex items-center">
                ...
                <label htmlFor="consent" className="ml-2 block text-sm text-gray-900">
                  I agree to the Terms and Conditions and authorize MoneyView to access my credit information.
                </label>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-6">
          {offers.offerObjects.map((offer, index) => (
            <div key={index} className="bg-white p-6 rounded-lg shadow">
              <h2 className="text-lg font-medium mb-4">Loan Offer {index + 1}</h2>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <p className="text-lg font-medium">{offer.loanTenure} months</p>
                </div>
                <div>
